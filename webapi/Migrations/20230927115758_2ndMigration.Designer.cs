...
namespace webapi.Migrations
{
    ...
    [Migration("20230927115758_2ndMigration")]
            ...
            modelBuilder.Entity("webapi.Domain.Models.HdUsers", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            Created_at = new DateTime(2023, 9, 27, 11, 57, 58, 279, DateTimeKind.Utc).AddTicks(3031),
                            DarkMode = false,
                            Deleted = false,
                            Department_Id = "0",
                            Department_Name = "0",
                            ...
                            IsBackOffice = false,
                            IsSuperVisor = false,
                            LastLogoutDate = new DateTime(2023, 9, 27, 11, 57, 58, 279, DateTimeKind.Utc).AddTicks(3031),
                            LastPasswordChange = new DateTime(2023, 9, 27, 11, 57, 58, 279, DateTimeKind.Utc).AddTicks(3031),
                            LastSeen = new DateTime(2023, 9, 27, 11, 57, 58, 279, DateTimeKind.Utc).AddTicks(3031),
                            Lastname = "Hermes",
                            Password = "$2a$10$YGoPR2GUot.aGA68z14KWeQTwZTGR25ZsWGhm652O3fxU8rhG6qoi",
                            Phone = "+97144464100",
                            Status = "Offline",
                            Updated_at = new DateTime(2023, 9, 27, 11, 57, 58, 279, DateTimeKind.Utc).AddTicks(3031),
                            User_Id = "1",
                            Username = "admin"
                        },
                        new
                        {
                            ...
                            LastSeen = new DateTime(2023, 9, 27, 11, 57, 58, 279, DateTimeKind.Utc).AddTicks(3031),
                            Lastname = "Hermes",
                            Password = "$2a$10$fMljW35kM.qCsJjetp5/LuP5w2OcL9BbbfAlr2ZLtM/6.D7ZPs1n.",
                            Phone = "+97144464100",
                            Status = "Offline",
                            Updated_at = new DateTime(2023, 9, 27, 11, 57, 58, 279, DateTimeKind.Utc).AddTicks(3031),
                            User_Id = "4",
                        ...
                        new
                        {
                            ...
                            LastSeen = new DateTime(2023, 9, 27, 11, 57, 58, 279, DateTimeKind.Utc).AddTicks(3031),
                            Lastname = "Hermes",
                            Password = "$2a$10$rL.9nAlOfQEECwz6aaoX2OYu.UJC0zrf2GaSCWpV9NOaXpbOUoImS",
                            Phone = "+97144464100",
                            Status = "Offline",
                            Updated_at = new DateTime(2023, 9, 27, 11, 57, 58, 279, DateTimeKind.Utc).AddTicks(3031),
                            User_Id = "2",
                        ...
                        new
                        {
                            ...
                            LastSeen = new DateTime(2023, 9, 27, 11, 57, 58, 279, DateTimeKind.Utc).AddTicks(3031),
                            Lastname = "Hermes",
                            Password = "$2a$10$klvStRv4BMRCuZcKsYex9OI/u08.eT1hnIcaJ9stdoMRq1NV4g.MK",
                            Phone = "+97144464100",
                            Status = "Offline",
                            Updated_at = new DateTime(2023, 9, 27, 11, 57, 58, 279, DateTimeKind.Utc).AddTicks(3031),
                            User_Id = "3",
