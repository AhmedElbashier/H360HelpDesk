...
namespace webapi.Migrations
{
    ...
    [Migration("20250717153829_EscalationsMigration")]
    partial class EscalationsMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("webapi.Domain.Models.EscalationProfile", b =>
                {
                    ...
                    b.Property<int?>("EscalationLevelLevelID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EscalationLevelLevelID");
            ...
            modelBuilder.Entity("webapi.Domain.Models.HdUsers", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            Created_at = new DateTime(2025, 7, 17, 15, 38, 29, 317, DateTimeKind.Utc).AddTicks(8358),
                            DarkMode = false,
                            Deleted = false,
                            Department_Id = "0",
                            Department_Name = "0",
                            ...
                            IsSuperVisor = false,
                            LastLogoutDate = new DateTime(2025, 7, 17, 15, 38, 29, 317, DateTimeKind.Utc).AddTicks(8358),
                            LastPasswordChange = new DateTime(2025, 7, 17, 15, 38, 29, 317, DateTimeKind.Utc).AddTicks(8358),
                            LastSeen = new DateTime(2025, 7, 17, 15, 38, 29, 317, DateTimeKind.Utc).AddTicks(8358),
                            Lastname = "Hermes",
                            Password = "$2a$10$72lgLiCgVQOoUjKaUc/P8.VMQwH5Il46IlR8VsHjL0r08Ryael9a.",
                            Phone = "+97144464100",
                            Status = "Offline",
                            Updated_at = new DateTime(2025, 7, 17, 15, 38, 29, 317, DateTimeKind.Utc).AddTicks(8358),
                            User_Id = "1",
                            Username = "admin"
                        },
                        new
                        {
                            ...
                            LastSeen = new DateTime(2025, 7, 17, 15, 38, 29, 317, DateTimeKind.Utc).AddTicks(8358),
                            Lastname = "Hermes",
                            Password = "$2a$10$jpttcGtdzZzpOrgC6al7x.7VM62LGUzfP3./SebpZez7hRnDndtNS",
                            Phone = "+97144464100",
                            Status = "Offline",
                            Updated_at = new DateTime(2025, 7, 17, 15, 38, 29, 317, DateTimeKind.Utc).AddTicks(8358),
                            User_Id = "4",
                        ...
                        new
                        {
                            ...
                            LastSeen = new DateTime(2025, 7, 17, 15, 38, 29, 317, DateTimeKind.Utc).AddTicks(8358),
                            Lastname = "Hermes",
                            Password = "$2a$10$ia.lWQtWs091cADg9SKos.xpUTKt5yKOJW8KJ51OLINSBJAvhQzly",
                            Phone = "+97144464100",
                            Status = "Offline",
                            Updated_at = new DateTime(2025, 7, 17, 15, 38, 29, 317, DateTimeKind.Utc).AddTicks(8358),
                            User_Id = "2",
                        ...
                        new
                        {
                            ...
                            LastSeen = new DateTime(2025, 7, 17, 15, 38, 29, 317, DateTimeKind.Utc).AddTicks(8358),
                            Lastname = "Hermes",
                            Password = "$2a$10$3ql8wZwi.bxpLL5Oek3WXek7JzxSFee628Y5Olt00gykowOUcBUVO",
                            Phone = "+97144464100",
                            Status = "Offline",
                            Updated_at = new DateTime(2025, 7, 17, 15, 38, 29, 317, DateTimeKind.Utc).AddTicks(8358),
                            User_Id = "3",
            ...
            modelBuilder.Entity("webapi.Domain.Models.EscalationProfile", b =>
                {
                    b.HasOne("webapi.Domain.Models.EscalationLevel", null)
                        .WithMany("Profiles")
                        .HasForeignKey("EscalationLevelLevelID");
                });
