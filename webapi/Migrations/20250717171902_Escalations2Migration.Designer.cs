...
namespace webapi.Migrations
{
    ...
    [Migration("20250717171902_Escalations2Migration")]
    partial class Escalations2Migration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("webapi.Domain.Models.HdUsers", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            Created_at = new DateTime(2025, 7, 17, 17, 19, 2, 709, DateTimeKind.Utc).AddTicks(3364),
                            DarkMode = false,
                            Deleted = false,
                            Department_Id = "0",
                            Department_Name = "0",
                            ...
                            IsSuperVisor = false,
                            LastLogoutDate = new DateTime(2025, 7, 17, 17, 19, 2, 709, DateTimeKind.Utc).AddTicks(3364),
                            LastPasswordChange = new DateTime(2025, 7, 17, 17, 19, 2, 709, DateTimeKind.Utc).AddTicks(3364),
                            LastSeen = new DateTime(2025, 7, 17, 17, 19, 2, 709, DateTimeKind.Utc).AddTicks(3364),
                            Lastname = "Hermes",
                            Password = "$2a$10$ZOcNKHHYO/87NPnQE8NOI.HPJ/w489s3rhqny/kUrHBr1zD7tH4JO",
                            Phone = "+97144464100",
                            Status = "Offline",
                            Updated_at = new DateTime(2025, 7, 17, 17, 19, 2, 709, DateTimeKind.Utc).AddTicks(3364),
                            User_Id = "1",
                            Username = "admin"
                        },
                        new
                        {
                            ...
                            LastSeen = new DateTime(2025, 7, 17, 17, 19, 2, 709, DateTimeKind.Utc).AddTicks(3364),
                            Lastname = "Hermes",
                            Password = "$2a$10$btQA1/CfVJT9lPaklnenHecGP8CD5zXxPdKOF1G31ZUtgnpidvZVi",
                            Phone = "+97144464100",
                            Status = "Offline",
                            Updated_at = new DateTime(2025, 7, 17, 17, 19, 2, 709, DateTimeKind.Utc).AddTicks(3364),
                            User_Id = "4",
                        ...
                        new
                        {
                            ...
                            LastSeen = new DateTime(2025, 7, 17, 17, 19, 2, 709, DateTimeKind.Utc).AddTicks(3364),
                            Lastname = "Hermes",
                            Password = "$2a$10$iQZMyomdln2vziTsiluUbOaDsz.FxNeq7RKORvzTiSs0XHyxpPOj2",
                            Phone = "+97144464100",
                            Status = "Offline",
                            Updated_at = new DateTime(2025, 7, 17, 17, 19, 2, 709, DateTimeKind.Utc).AddTicks(3364),
                            User_Id = "2",
                        ...
                        new
                        {
                            ...
                            LastSeen = new DateTime(2025, 7, 17, 17, 19, 2, 709, DateTimeKind.Utc).AddTicks(3364),
                            Lastname = "Hermes",
                            Password = "$2a$10$w8KtV6TWM/DdVH6YyClRvOSjLpyRR904/ItevjABW0n9qITULLqTW",
                            Phone = "+97144464100",
                            Status = "Offline",
                            Updated_at = new DateTime(2025, 7, 17, 17, 19, 2, 709, DateTimeKind.Utc).AddTicks(3364),
                            User_Id = "3",
            ...
            modelBuilder.Entity("webapi.Domain.Models.EscalationProfile", b =>
                {
                    b.HasOne("webapi.Domain.Models.EscalationLevel", "EscalationLevel")
                        .WithMany("Profiles")
