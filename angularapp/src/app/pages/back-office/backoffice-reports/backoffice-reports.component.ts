...
@Component({
  selector: 'app-backoffice-reports',
  templateUrl: './backoffice-reports.component.html',
  styleUrls: ['./backoffice-reports.component.css']
})
export class BackofficeReportsComponent {
  tickets: Ticket[] = [];
  priorities: Priority[] = []
  ...
  generateReport() {
    ...
    this.reportService.getBackOfficeReport(this.reportData).then(
      (res) => {
        console.log(res);
        this.tickets = res;
