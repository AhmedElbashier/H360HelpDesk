...
@Component({
  selector: 'app-supervisor-ticket-details',
  templateUrl: './supervisor-ticket-details.component.html',
  styleUrls: ['./supervisor-ticket-details.component.css']
})
export class SupervisorTicketDetailsComponent {
  title = 'customEditor';
  ...
  async ngOnInit() {
    ...
    this.ticket = JSON.parse(localStorage.getItem("SupervisorTicketDetails") || "{}") as Ticket;
    await this.getFiles();
